...
import { AnimationEventHandler, ChangeEventHandler, MouseEventHandler, TransitionEventHandler, useEffect, useRef } from "react";
...
export default function DishCard(props: DishCardProps) {
  ...
  function handleDeleteClick() {
    cardRef.current.style.transform = "scaleX(0)"
  }

  function deleteDish(event: TransitionEventInit) {
